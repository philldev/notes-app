...
const NewFolder: FC<NewFolderProps> = (props) => {
	...
	if (isAdding) {
		return (
			<div style={{paddingTop: '100%' }} className='relative flex items-end justify-center rounded-2xl bg-bg-2'>
				...
				<input
					...
					className='absolute w-full text-sm text-center bg-transparent outline-none bottom-2'
				/>
			</div>
		)
	}
